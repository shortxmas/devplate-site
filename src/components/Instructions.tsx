...
const Instructions = () => {
  const installation =
    "Run ```npm install -g devplate``` to install the Devplate CLI globally and make sure you have the Git CLI";
